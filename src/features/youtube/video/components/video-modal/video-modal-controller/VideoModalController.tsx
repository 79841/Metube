import { useDndPositionDispatchContext } from "features/common/dnd/context";
import { useWidthDispatchContext } from "features/common/resizable/context";
import { useSelectedVideoStore } from "lib/zustand";
import { CloseButton, MaxButton, MinButton } from "./buttons";
import { useVideoDragging } from "./useVideoDragging";
